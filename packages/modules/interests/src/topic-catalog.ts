...
export const TOPIC_CATALOG: TopicDefinition[] = [
  {
    key: 'travel', type: EntityType.TOPIC, category: 'travel', symbol: 'airplane',
    names: { vi: 'Du lịch', en: 'Travel' },
    descriptions: { vi: 'Điểm đến, visa, thời tiết và thay đổi hành trình.', en: 'Destinations, visas, weather and travel changes.' },
  ...
  {
    key: 'markets', type: EntityType.TOPIC, category: 'investments', symbol: 'chart.line.uptrend.xyaxis',
    names: { vi: 'Thị trường & đầu tư', en: 'Markets & investing' },
    descriptions: { vi: 'Cổ phiếu, vàng, crypto và các biến động quan trọng.', en: 'Stocks, gold, crypto and meaningful market moves.' },
  ...
  {
    key: 'technology', type: EntityType.TECHNOLOGY, category: 'work', symbol: 'cpu',
    names: { vi: 'Công nghệ', en: 'Technology' },
    descriptions: { vi: 'Sản phẩm, nền tảng và thay đổi kỹ thuật đáng chú ý.', en: 'Products, platforms and important technical changes.' },
  ...
  {
    key: 'career', type: EntityType.JOB, category: 'work', symbol: 'briefcase',
    names: { vi: 'Sự nghiệp', en: 'Career' },
    descriptions: { vi: 'Ngành nghề, kỹ năng và cơ hội liên quan đến công việc.', en: 'Industries, skills and opportunities related to work.' },
  ...
  {
    key: 'health', type: EntityType.TOPIC, category: 'health', symbol: 'heart',
    names: { vi: 'Sức khỏe', en: 'Health' },
    descriptions: { vi: 'Thông tin sức khỏe và thói quen mà anh chủ động theo dõi.', en: 'Health information and habits you choose to follow.' },
    refinementLabels: { vi: 'Mối quan tâm cụ thể', en: 'Specific areas' },
    refinementPlaceholders: { vi: 'Giấc ngủ, chạy bộ, dinh dưỡng', en: 'Sleep, running, nutrition' },
  },
  {
    key: 'sports', type: EntityType.SPORTS_TEAM, category: 'sports', symbol: 'sportscourt',
  ...
  {
    key: 'entertainment', type: EntityType.MOVIE, category: 'entertainment', symbol: 'film',
    names: { vi: 'Giải trí', en: 'Entertainment' },
    descriptions: { vi: 'Phim, nghệ sĩ và nội dung sắp phát hành.', en: 'Films, artists and upcoming releases.' },
  ...
  {
    key: 'products', type: EntityType.PRODUCT, category: 'purchases', symbol: 'bag',
    names: { vi: 'Sản phẩm muốn mua', en: 'Products to buy' },
    descriptions: { vi: 'Giá, phiên bản mới và thay đổi đáng cân nhắc.', en: 'Prices, new versions and changes worth considering.' },
